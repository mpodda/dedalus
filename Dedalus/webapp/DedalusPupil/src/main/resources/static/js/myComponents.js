class SelectComponent extends M2MJS.Component {
...
class ActivationButton extends M2MJS.Component {
	...
	initEvents() {
		...
		M2MJS.XBrowser.addHandler(activationButton.element, "click", (e) => {
...
class RadioSet extends M2MJS.Component {
